...
Enabling your application to provide noise cancellation for the audio in the call can be very useful for you users. We understand though, that this can be a difficult feature to implement/support.
