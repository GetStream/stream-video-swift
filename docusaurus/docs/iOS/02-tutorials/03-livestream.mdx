...
Note that this tutorial was written using **XCode 14**. Setup steps can vary slightly across Xcode versions.
We recommend using Xcode 14 or newer.

1. Create a new project
2. Select iOS -> App in the new project template
3. Select SwiftUI as the interface for your app
4. Name your project **LivestreamSampleApp**.
...
- Required permissions for camera and microphone ("Privacy - Camera Usage Description" and "Privacy - Microphone Usage Description" in your `Info.plist` file)
