...
struct AudioRoomsApp: App {
    ...
    init() {
        ...
        self.streamVideo = StreamVideo(
            ...
            user: currentUser,
            token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoidHV0b3JpYWxAZ2V0c3RyZWFtLmlvIiwiaXNzIjoicHJvbnRvIiwic3ViIjoidXNlci90dXRvcmlhbEBnZXRzdHJlYW0uaW8iLCJpYXQiOjE2ODY3NDY4MDksImV4cCI6MTY4NzM1MTYxNH0.j14I3udGgr_pfkS0_Jz8s7xR7gRzitP58fjTjLkbnk8"
        )
    }
        ...
        WindowGroup {
            Group {
                ...
                Task {
                    ...
                    call = streamVideo?.call(callType: .audioRoom, callId: "123")
                    try await call?.join()
                }
            }
        }
