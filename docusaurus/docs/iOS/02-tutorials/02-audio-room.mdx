...
struct AudioRoomsApp: App {
    ...
    private let userId: String = "Kit_Fisto" // The User Id can be found in the Credentials section
    private let token: String = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiS2l0X0Zpc3RvIiwiaXNzIjoicHJvbnRvIiwic3ViIjoidXNlci9LaXRfRmlzdG8iLCJpYXQiOjE2ODgxMTIyNTYsImV4cCI6MTY4ODcxNzA2MX0.S7iukA9r81BekOEwqniiKZAg4IOBvjiCnwuMe9DYkvU" // The Token can be found in the Credentials section
    private let callId: String = "QpZcx7wt3aFL" // The CallId can be found in the Credentials section
