...
extension CMVideoDimensions {
    ...
    public static let full = CMVideoDimensions(width: 1280, height: 720)
    public static let half = CMVideoDimensions(width: 640, height: 480)
    public static let quarter = CMVideoDimensions(width: 480, height: 360)
