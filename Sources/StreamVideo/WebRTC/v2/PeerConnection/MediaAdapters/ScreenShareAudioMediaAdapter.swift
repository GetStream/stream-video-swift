...
final class ScreenShareAudioMediaAdapter: MediaAdapting, @unchecked Sendable {
    ...
    /// Convenience initializer for creating an AudioMediaAdapter with a LocalScreenShareAudioMediaAdapter.
    ///
    /// - Parameters:
    ...
    convenience init(
        ...
        self.init(
            ...
            peerConnectionFactory: peerConnectionFactory,
            localMediaManager: LocalScreenShareAudioMediaAdapter(
                sessionID: sessionID,
                peerConnection: peerConnection,
                peerConnectionFactory: peerConnectionFactory,
                sfuAdapter: sfuAdapter,
    ...
    func changePublishQuality(
        ...
        (localMediaManager as? LocalScreenShareAudioMediaAdapter)?
    ...
    func begin(
        ...
        guard
            let adapter = localMediaManager as? LocalScreenShareAudioMediaAdapter
        else {
            return
        }

        try await adapter.begin(ownCapabilities: ownCapabilities)
    }
