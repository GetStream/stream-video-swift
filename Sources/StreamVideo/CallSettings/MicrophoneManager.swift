...
public final class MicrophoneManager: ObservableObject, CallSettingsManager, @unchecked Sendable {
    ...
    public func setHiFiEnabled(_ isEnabled: Bool) async {
        await setAudioBitrateType(isEnabled ? .musicHighQuality : .voiceStandard)
    }

    public func setAudioBitrateType(_ value: AudioBitrate) async {
        await callController.setAudioInputBitrate(value)
    }
