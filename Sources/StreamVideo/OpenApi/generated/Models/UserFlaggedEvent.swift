...
public final class UserFlaggedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: UserFlaggedEvent, rhs: UserFlaggedEvent) -> Bool {
