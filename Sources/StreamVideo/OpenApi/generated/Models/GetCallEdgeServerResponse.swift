//
// GetCallEdgeServerResponse.swift
//
...
internal struct GetCallEdgeServerResponse: Codable, JSONEncodable, Hashable {
    ...
    internal init(blockedUsers: [UserResponse], call: CallResponse, credentials: Credentials, duration: String, members: [MemberResponse], membership: MemberResponse? = nil) {
