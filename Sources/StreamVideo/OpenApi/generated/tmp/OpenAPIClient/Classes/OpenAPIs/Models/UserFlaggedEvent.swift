...
public struct UserFlaggedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable, WSClientEvent {
    ...
    public init(createdAt: Date, targetUser: String? = nil, targetUsers: [String]? = nil, type: String = "user.flagged", user: UserObject? = nil) {
