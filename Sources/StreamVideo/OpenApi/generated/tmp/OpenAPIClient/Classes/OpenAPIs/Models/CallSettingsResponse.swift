...
public struct CallSettingsResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(audio: AudioSettingsResponse, backstage: BackstageSettingsResponse, broadcasting: BroadcastSettingsResponse, geofencing: GeofenceSettingsResponse, limits: LimitsSettingsResponse, recording: RecordSettingsResponse, ring: RingSettingsResponse, screensharing: ScreensharingSettingsResponse, thumbnails: ThumbnailsSettingsResponse, transcription: TranscriptionSettingsResponse, video: VideoSettingsResponse) {
        self.audio = audio
