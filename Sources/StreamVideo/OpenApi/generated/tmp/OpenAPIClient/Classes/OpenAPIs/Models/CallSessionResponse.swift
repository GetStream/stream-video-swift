...
public struct CallSessionResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(acceptedBy: [String: Date], endedAt: Date? = nil, id: String, liveEndedAt: Date? = nil, liveStartedAt: Date? = nil, missedBy: [String: Date], participants: [CallParticipantResponse], participantsCountByRole: [String: Int], rejectedBy: [String: Date], startedAt: Date? = nil, timerEndsAt: Date? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(missedBy, forKey: .missedBy)
