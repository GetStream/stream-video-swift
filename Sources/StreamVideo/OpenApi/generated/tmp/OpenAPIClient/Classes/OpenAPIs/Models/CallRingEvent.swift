...
public struct CallRingEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable, WSCallEvent {
    ...
    public init(call: CallResponse, callCid: String, createdAt: Date, members: [MemberResponse], sessionId: String, type: String = "call.ring", user: UserResponse, video: Bool) {
        self.call = call
