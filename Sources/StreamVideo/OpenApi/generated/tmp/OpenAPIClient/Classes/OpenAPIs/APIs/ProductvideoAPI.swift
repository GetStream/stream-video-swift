...
protocol ProductvideoAPITransport: Sendable {
    func execute(request: Request) async throws -> (Data, URLResponse)
}

protocol ProductvideoAPIClientMiddleware: Sendable {
    func intercept(
        _ request: Request,
...
open class ProductvideoAPI: ProductvideoAPIEndpoints, @unchecked Sendable {
    internal var transport: ProductvideoAPITransport
    internal var middlewares: [ProductvideoAPIClientMiddleware]
    internal var basePath: String
    internal var jsonDecoder: JSONDecoder

    init(basePath: String, transport: ProductvideoAPITransport, middlewares: [ProductvideoAPIClientMiddleware], jsonDecoder: JSONDecoder = JSONDecoder.default) {
    ...
    /**
     ...
     - returns: QueryCallMembersResponse
     */

    open func queryCallMembers(queryCallMembersRequest: QueryCallMembersRequest) async throws -> QueryCallMembersResponse {
        ...
        return try await send(request: urlRequest) {
            try self.jsonDecoder.decode(QueryCallMembersResponse.self, from: $0)
        }
    }
    /**
     Query call members
    ...
    /**
     ...
     - returns: SendCallEventResponse
     */

    open func sendCallEvent(type: String, id: String, sendCallEventRequest: SendCallEventRequest) async throws -> SendCallEventResponse {
        ...
        return try await send(request: urlRequest) {
            try self.jsonDecoder.decode(SendCallEventResponse.self, from: $0)
        }
    }
    /**
     Send custom event
...
protocol ProductvideoAPIEndpoints {
        ...
        func queryCallMembers(queryCallMembersRequest: QueryCallMembersRequest) async throws -> QueryCallMembersResponse
        ...
        func sendCallEvent(type: String, id: String, sendCallEventRequest: SendCallEventRequest) async throws -> SendCallEventResponse
