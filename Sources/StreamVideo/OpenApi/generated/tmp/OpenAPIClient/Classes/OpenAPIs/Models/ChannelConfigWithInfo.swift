...
public struct ChannelConfigWithInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(allowedFlagReasons: [String]? = nil, automod: Automod, automodBehavior: AutomodBehavior, automodThresholds: Thresholds? = nil, blocklist: String? = nil, blocklistBehavior: BlocklistBehavior? = nil, blocklists: [BlockListOptions]? = nil, commands: [Command], connectEvents: Bool, createdAt: Date, customEvents: Bool, grants: [String: [String]]? = nil, markMessagesPending: Bool, maxMessageLength: Int, mutes: Bool, name: String, polls: Bool, pushNotifications: Bool, quotes: Bool, reactions: Bool, readEvents: Bool, reminders: Bool, replies: Bool, search: Bool, typingEvents: Bool, updatedAt: Date, uploads: Bool, urlEnrichment: Bool) {
