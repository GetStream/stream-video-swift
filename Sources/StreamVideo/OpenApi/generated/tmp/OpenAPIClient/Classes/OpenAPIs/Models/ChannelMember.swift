...
public struct ChannelMember: Codable, JSONEncodable, Hashable {
    ...
    public init(banExpires: Date? = nil, banned: Bool, channelRole: String, createdAt: Date, deletedAt: Date? = nil, inviteAcceptedAt: Date? = nil, inviteRejectedAt: Date? = nil, invited: Bool? = nil, isModerator: Bool? = nil, notificationsMuted: Bool, shadowBanned: Bool, status: String? = nil, updatedAt: Date, user: UserObject? = nil, userId: String? = nil) {
