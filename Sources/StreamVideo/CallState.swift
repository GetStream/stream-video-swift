...
public class CallState: ObservableObject {
    ...
    @Published public internal(set) var screenSharingSession: ScreenSharingSession? = nil {
        didSet {
            ...
            if isCurrentUserSharing, screenSharingSession?.hasScreenshareAudiotrack == true {
                isCurrentUserScreensharingAudio = true
            } else {
                isCurrentUserScreensharingAudio = false
            }
        }
    }
    ...
    @Published public internal(set) var isCurrentUserScreensharingAudio: Bool = false
    ...
    private func didUpdate(_ newParticipants: [CallParticipant]) {
        ...
        for participant in updatedCurrentParticipants {
            ...
            if let screenshareTrack = participant.screenshareTrack, participant.isScreensharing {
                screenSharingSession = .init(
                    track: screenshareTrack,
                    hasScreenshareAudiotrack: participant.hasScreenshareAudiotrack,
