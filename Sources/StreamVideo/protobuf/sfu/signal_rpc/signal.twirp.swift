...
class Stream_Video_Sfu_Signal_SignalServer: @unchecked Sendable {
	...
	func updateMuteState(updateMuteStateRequest: Stream_Video_Sfu_Signal_UpdateMuteStateRequest) async throws -> Stream_Video_Sfu_Signal_UpdateMuteStateResponse {
        return try await execute(request: updateMuteStateRequest, path: "UpdateMuteState")
	}
    
	func requestVideoQuality(updateVideoQualityRequest: Stream_Video_Sfu_Signal_UpdateVideoQualityRequest) async throws -> Stream_Video_Sfu_Signal_UpdateVideoQualityResponse {
        return try await execute(request: updateVideoQualityRequest, path: "RequestVideoQuality")
	}
