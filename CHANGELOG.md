...
- Fixed an issue that was causing confusion to the shared AudioSession object when multiple Call instances are in memory. [#851](https://github.com/GetStream/stream-video-swift/pull/851)
