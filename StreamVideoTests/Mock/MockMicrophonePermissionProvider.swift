...
final class MockMicrophonePermissionProvider: MicrophonePermissionProviding, Mockable, @unchecked Sendable {
    ...
    func stub<T>(for keyPath: KeyPath<MockMicrophonePermissionProvider, T>, with value: T) {
